...
class CI_Cart {
	...
	public function __construct($params = array())
	{
		...
		if ($this->CI->session->userdata('cart_contents_gyn') !== FALSE)
		{
			$this->_cart_contents = $this->CI->session->userdata('cart_contents_gyn');
		}
		else
		{
	...
	function _save_cart()
	{
		...
		{
			$this->CI->session->unset_userdata('cart_contents_gyn');
		...
		$this->CI->session->set_userdata(array('cart_contents_gyn' => $this->_cart_contents));
