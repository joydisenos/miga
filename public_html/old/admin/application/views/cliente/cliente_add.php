			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="form-container table-container">
						<form id="form-guardar" class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>cliente/guardar" method="POST">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="row">
									...
									<div class="col-md-6 col-xs-12 col-sm-6">
										<div class="form-group <?php if(form_error('correo')) { echo 'has-error  has-feedback'; } ?>">
											...
											<input class="form-control" name="correo" id="correo" placeholder="Correo" value="<?php echo set_value('correo'); ?>">
								...
								<div class="row">
									<div class="col-md-6 col-xs-12 col-sm-6">
										<div class="form-group <?php if(form_error('direccion')) { echo 'has-error  has-feedback'; } ?>">
											...
											<input class="form-control" name="direccion" id="direccion" placeholder="Direcci&oacute;n" value="<?php echo set_value('direccion'); ?>">
									...
									<div class="col-md-2 col-xs-4 col-sm-2">
										<div class="form-group <?php if(form_error('codigo_area')) { echo 'has-error  has-feedback'; } ?>">
											...
											<input class="form-control" name="codigo_area" id="codigo_area" placeholder="C&oacute;digo de Area" value="<?php echo set_value('codigo_area'); ?>">
									...
									<div class="col-md-4 col-xs-8 col-sm-4">
										<div class="form-group <?php if(form_error('telefono')) { echo 'has-error  has-feedback'; } ?>">
											...
											<input class="form-control" name="telefono" id="telefono" placeholder="Tel&eacute;fono" value="<?php echo set_value('telefono'); ?>">
								...
								<div class="row">
									<div class="col-md-6 col-xs-12 col-sm-6">
										<div class="form-group <?php if(form_error('puntos_acumulados')) { echo 'has-error  has-feedback'; } ?>">
											...
											<input class="form-control" name="puntos_acumulados" id="puntos_acumulados" placeholder="Puntos Acumulados" value="<?php echo set_value('puntos_acumulados'); ?>">
