			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="table-label">
						<strong>Editar Horarios Especiales<strong>
					</div>
					...
					<div class="form-container table-container">
						<form id="form-guardar" class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>horarios/actualizarespeciales/<?=$fila->id?>" method="POST">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="row">
									<div class="col-md-2 col-xs-6 col-sm-4">
										<div class="form-group <?php if(form_error('dia')) { echo 'has-error  has-feedback'; } ?>">
											<label for="dia">D&iacute;a</label>
											<input class="form-control" name="dia" id="dia" placeholder="D&iacute;a" value="<?php if(set_value('dia')) {echo set_value('dia');}else{echo $fila->dia;} ?>">
									...
									<div class="col-md-2 col-xs-6 col-sm-4">
										<div class="form-group <?php if(form_error('mes')) { echo 'has-error  has-feedback'; } ?>">
											...
											<input class="form-control" name="mes" id="mes" placeholder="Mes" value="<?php if(set_value('mes')) {echo set_value('mes');}else{echo $fila->mes;} ?>">
									...
									<div class="col-md-4 col-xs-12 col-sm-4">
										<div class="form-group <?php if(form_error('horario')) { echo 'has-error  has-feedback'; } ?>">
											...
											<input class="form-control" name="horario" id="horario" placeholder="Horario" value="<?php if(set_value('horario')) {echo set_value('horario');}else{echo $fila->horario;} ?>">
