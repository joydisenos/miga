...
<body>
    ...
    <tbody>
      ...
      <tr>
		...
		<div class="radio">
			<label>
				<input type="radio" name="pago" id="pago" value="tarjeta al delivery"> <b>Tarjeta de Crédito / Débito al delivery
				</b>
				<br>
				<img src="img/p1.png" alt="" height="20">
					<img src="img/p2.png" alt="" height="20">
					...
					<img src="img/p5.png" alt="" height="20">
					<img src="img/p7.png" alt="" height="20">
				<small>(A través de Mercado Point)</small>
		...
		<div class="panel panel-default">
			...
			<b>Total a abonar:</b> 
			<span class="sc-cart-summary-subtotal" style="float:right;"> 
						<font color="green"><b><span class="sc-cart-subtotal">$<span id="Display2"><?php print $costo_promo; ?> </span></span></b></font>
			</span>
			</p>
			</div>
			<div class="form-group">
